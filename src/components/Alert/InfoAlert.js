...
const InfoAlert = () => {
    ...
    return (
        <div className="alert alert-secondary mb-5" role="alert">
            ...
            <p className="fw-bold mb-1"><span className="fw-bold text-decoration-underline">No data are saved</span> and <span className="fw-bold text-decoration-underline">an order is not possible</span>!</p>
        </div>
    )
}
